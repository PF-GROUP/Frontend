        ...
        >
            {({ isSubmitting, values, handleBlur, handleChange, handleSubmit, errors, touched }) => (
                ...
                >
                    ...
                    <h2 className="font-bold text-2xl md:text-3xl mt-4 mb-4">Crear una cuenta</h2>
                    ...
                    <div className="w-full flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex flex-col w-full m-1">
                                <label htmlFor="name" className="mt-2 text-black text-base md:text-xl">Nombre</label>
                                <input
                                    type="text"
                                    id="name"
                                    name="name"
                                ...
                                />
                                <p className="text-sm text-red-500">{errors.name && touched.name && errors.name}</p>
                            </div>
                            ...
                            <div className="flex flex-col w-full m-1">
                                ...
                                <input
                                    ...
                                    className="text-black bg-white border border-[#4e4b4b] rounded-sm p-2 focus:border-[#a0a0a0]"
                                />
                                <p className="text-sm text-red-500">{errors.surname && touched.surname && errors.surname}</p>
                            </div>
                            ...
                            <div className="flex flex-col w-full m-1">
                                ...
                                <input
                                    ...
                                    className="text-black bg-white border border-[#4e4b4b] rounded-sm p-2 focus:border-[#a0a0a0]"
                                />
                                <p className="text-sm text-red-500">{errors.phone && touched.phone && errors.phone}</p>
                            </div>
                            ...
                            <div className="flex flex-col w-full m-1">
                                ...
                                <input
                                    ...
                                    className="text-black bg-white border border-[#4e4b4b] rounded-sm p-2 focus:border-[#a0a0a0]"
                                />
                                <p className="text-sm text-red-500">{errors.document && touched.document && errors.document}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col w-full mt-2">
                            ...
                            <div className="flex flex-col w-full m-1">
                                ...
                                <input
                                    ...
                                    className="text-black bg-white border border-[#4e4b4b] rounded-sm p-2 focus:border-[#a0a0a0]"
                                />
                                <p className="text-sm text-red-500">{errors.agencyName && touched.agencyName && errors.agencyName}</p>
                            </div>
                            ...
                            <div className="flex flex-col w-full m-1">
                                ...
                                <input
                                    ...
                                    className="text-black bg-white border border-[#4e4b4b] rounded-sm p-2 focus:border-[#a0a0a0]"
                                />
                                <p className="text-sm text-red-500">{errors.agencyDescription && touched.agencyDescription && errors.agencyDescription}</p>
                            </div>
                            ...
                            <div className="flex flex-col w-full m-1">
                                ...
                                <input
                                    ...
                                    className="text-black bg-white border border-[#4e4b4b] rounded-sm p-2 focus:border-[#a0a0a0]"
                                />
                                <p className="text-sm text-red-500">{errors.slug && touched.slug && errors.slug}</p>
                            </div>
                        </div>
                    </div>
